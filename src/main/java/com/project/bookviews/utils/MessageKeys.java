package com.project.bookviews.utils;
...
public class MessageKeys {
    ...
    public static final String UPLOAD_MP3S_MAX_5 = "product.upload_mp3.error_max_5_mp3s";
    ...
    public static final String IMAGE_NOT_FOUND = "user.login.image_not_found";
